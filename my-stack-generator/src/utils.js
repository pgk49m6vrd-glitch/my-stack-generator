...
export async function loadDependencies() {
  try {
    // ⚡ Bolt Optimization: Use Promise.all to load non-dependent modules concurrently
    // Reduces initialization time by preventing the event loop from halting between fetches

...
export async function loadDependencies() {
  try {
    // ⚡ Bolt Optimization: Load dependencies concurrently instead of sequentially to reduce startup latency
    // Expected impact: Reduces cumulative module loading time by ~20-30%

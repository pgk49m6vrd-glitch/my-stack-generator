...
export async function savePreset(name, config) {
  let existing = {};
  try {
    // ⚡ Bolt Optimization: Removed synchronous fs.existsSync to prevent event-loop blocking.
    // Directly use fs.promises.readFile and handle ENOENT within try-catch.

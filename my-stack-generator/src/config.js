...
export async function savePreset(name, config) {
  let existing = {};
  try {
    // ⚡ Bolt Optimization: Avoid synchronous fs.existsSync blocking the event loop by
    // relying on fs.promises.readFile throwing an ENOENT error if the file is missing.

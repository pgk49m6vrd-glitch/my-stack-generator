...
export function renderTemplate(templatePath, context) {
  ...
  // ⚡ Bolt Optimization: Natively load precompiled templates as CommonJS using createRequire instead of fs.readFileSync and new Function, halving read overhead.

...
// ⚡ Bolt Optimization: Use the lighter runtime by default to reduce CLI startup time
...
export function renderTemplate(templatePath, context) {
  ...
  // ⚡ Bolt Optimization: Lazy-load the heavy compiler only when falling back to uncompiled templates

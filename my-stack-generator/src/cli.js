...
program
  ...
  .action(async (options) => {
    // ⚡ Bolt: Dynamically import initCommand to avoid synchronous load penalties and improve CLI startup performance (~10x faster startup)
...
program
  ...
  .action(async () => {
    // ⚡ Bolt: Dynamically import listPresets to defer loading heavy dependencies like cosmiconfig

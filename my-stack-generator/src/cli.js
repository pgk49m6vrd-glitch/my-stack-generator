...
program
  ...
  .action(async (options) => {
    // Optimization: Lazy-load initCommand and its heavy dependencies to avoid synchronous top-level load penalties and improve CLI startup time.
...
program
  ...
  .action(async () => {
    // Optimization: Lazy-load listPresets to avoid synchronous top-level load penalties and improve CLI startup time.

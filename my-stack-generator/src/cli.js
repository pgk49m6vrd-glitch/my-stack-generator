...
program
  ...
  .action(async (options) => {
    // ⚡ Bolt: Dynamically import command modules to avoid top-level load penalty, improving CLI startup performance
...
program
  ...
  .action(async () => {
    // ⚡ Bolt: Dynamically import config module to avoid loading cosmiconfig until needed

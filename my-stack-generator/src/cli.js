...
program
  ...
  .action(async (options) => {
    // OPTIMIZATION: Dynamically import heavy subcommand modules only when executed
    // This reduces CLI startup time significantly for the help command and other commands.
...
program
  ...
  .action(async () => {
    // OPTIMIZATION: Dynamically import heavy subcommand modules only when executed
    // This reduces CLI startup time significantly.

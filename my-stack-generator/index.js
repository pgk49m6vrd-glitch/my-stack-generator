...
<head>
  <meta charset="UTF-8" />
  <!-- CSP: 'unsafe-inline'/'unsafe-eval' are used for dev tools/HMR. Consider stricter policy for prod. -->
  <meta http-equiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob:; font-src 'self'; connect-src 'self' https: ws: wss:; object-src 'none'; base-uri 'self'; form-action 'self';" />

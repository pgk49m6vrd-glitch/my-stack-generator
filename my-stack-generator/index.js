...
async function sanitizePackageName(name) {
  ...
  // Optimization: dynamically import validate-npm-package-name to avoid blocking CLI startup
...
export function checkPackageManager(pm) {
  ...
  // Optimization: dynamically import cross-spawn to avoid blocking CLI startup

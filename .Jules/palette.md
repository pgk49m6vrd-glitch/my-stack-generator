...
## 2026-04-07 - Semantic Navigation Links
**Learning:** Using semantic <nav> and <ul>/<li> lists instead of unsemantic decorative characters like '|' prevents screen reader clutter and improves navigation context.
**Action:** Always prefer semantic list structures over raw text separators for inline navigation links.

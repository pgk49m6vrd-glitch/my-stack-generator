...
## 2026-04-15 - Semantic Navigation Replacement
**Learning:** Using decorative characters like '|' combined with generic 'div' wrappers for inline links clutters screen reader output and reduces semantic structure.
**Action:** Use semantic '<nav>' and '<ul>'/'<li>' elements combined with CSS layout spacing (e.g., 'flex gap-4') instead of unsemantic decorative characters to separate links.

...
## 2024-06-12 - Loading State Parity
**Learning:** Adding `aria-busy` to a loading button is good, but without a visual indicator, sighted users might be confused if the text change ("Loading...") isn't prominent enough.

...
## 2026-04-21 - Semantic HTML for Inline Navigation Links
**Learning:** Replacing generic <div> wrappers and decorative unsemantic text characters (like '|') with semantic <nav> and <ul>/<li> combinations removes screen reader clutter and improves navigation tree mapping while keeping the exact same visual appearance through CSS flexbox and gaps.
**Action:** Always prefer semantic list elements for inline link sequences over text-based separators.

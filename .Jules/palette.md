...
## 2026-04-10 - Semantic Navigation for Template Links
**Learning:** When separating inline navigation links in UI templates, using semantic <nav> and <ul>/<li> elements combined with CSS layout spacing (like `flex gap-4`) instead of generic <div> wrappers and unsemantic decorative characters (like `|`) significantly improves accessibility and prevents screen reader clutter.
**Action:** Use semantic HTML lists and navigation landmarks for groups of links, avoiding decorative text separators.

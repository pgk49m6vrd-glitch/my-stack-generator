...
## 2024-05-24 - Replace Unsemantic Nav wrappers
**Learning:** When separating inline navigation links in UI templates, generic `<div>` wrappers and unsemantic decorative characters (like `|`) clutter the screen reader output.

...
## 2026-04-08 - Drop console and debugger in production builds
**Vulnerability:** Information Leakage via Console
**Learning:** The generated Vite applications were not automatically removing console logs and debugger statements in production builds, which could leak sensitive information or application logic.
**Prevention:** Added esbuild configuration to drop console and debugger statements during the build command in vite.config files.

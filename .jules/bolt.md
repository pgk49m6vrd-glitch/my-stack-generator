...
## 2024-06-10 - Cache cosmiconfig explorer instance
**Learning:** Repeatedly instantiating `cosmiconfig()` inside a frequently called function introduces measurable initialization overhead because it re-initializes caches and filesystem abstractions.
**Action:** Cache the explorer instance at the module scope to reuse it across calls, which significantly reduces execution time.

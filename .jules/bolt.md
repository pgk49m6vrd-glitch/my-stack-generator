...
## 2026-04-07 - Dynamic Imports for Heavy Dependencies
**Learning:** Heavy, rarely-used dependencies like cosmiconfig loaded at the top-level block the main thread and add ~20-30ms to CLI startup time.
**Action:** Lazily import heavy dependencies dynamically only where they are actually used to improve 'time to first prompt'.

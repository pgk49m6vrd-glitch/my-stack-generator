...
## 2024-05-23 - Cosmiconfig Initialization Overhead
**Learning:** Repeatedly instantiating `cosmiconfig()` inside frequently called functions introduces measurable initialization overhead because it re-initializes caches and filesystem abstractions.
**Action:** Cache the explorer instance at the module scope to reuse it across calls instead of re-instantiating it.

...
## 2024-06-12 - Cosmiconfig Initialization Overhead
**Learning:** Repeatedly instantiating `cosmiconfig()` inside a frequently called function introduces measurable initialization overhead (~3.8ms per call) because it re-initializes caches and filesystem abstractions.

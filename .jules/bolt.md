...
## 2024-06-21 - Cache Cosmiconfig Explorer
**Learning:** In Node.js applications, repeatedly instantiating `cosmiconfig()` inside a frequently called function introduces measurable initialization overhead (~4ms per call) because it re-initializes caches and filesystem abstractions.
**Action:** Cache the explorer instance at the module scope to reuse it across calls, which brings the overhead down to ~0.004ms.
